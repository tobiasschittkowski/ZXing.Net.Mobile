...
namespace ZXing.Net.Mobile.Forms
{
    public class ZXingScannerView : View
    {
        ...
        public delegate void ScanResultDelegateWithImage(Result result, byte[] rawImage);

        public event ScanResultDelegate OnScanResult;
        public event ScanResultDelegateWithImage OnScanResultWithImage;
        ...
        public void RaiseScanResult(Result result, byte[] rawImage)
        {
            Result = result;
            OnScanResult?.Invoke(Result);
            OnScanResultWithImage?.Invoke(Result, rawImage);
            ScanResultCommand?.Execute(Result);
        }
